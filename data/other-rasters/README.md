* `dhi-data/dhi_ndvi_2015.tif` is from doi.org/10.1016/j.rse.2018.12.009
...
* `dcz-riskmap/DCZ_riskmap_wmean_masked.tif` is the risk map for dengue, chikungunya, Zika, and yellow feve from https://github.com/ahyoung-lim/Arbo_riskmaps_public/blob/main/outputs/Rasters/DCZ_riskmap_wmean_masked.tif
* `wc2.1_2.5m_prec/*` and `wc2.1_2.5m_tavg/*` are from https://www.worldclim.org/data/worldclim21.html
