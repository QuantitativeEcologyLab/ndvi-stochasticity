...
The second set of tests presented here use data from a large taiga ecozone (Fig. B.\@ref(fig:taiga-map)). Fig. B.\@ref(fig:taiga-aggr-example) shows the first few rasters before and after spatiotemporal aggregation by a factor of 2.
...
* prop-water-distr.png
* prop-water-estimates.png
