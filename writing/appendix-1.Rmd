...
```{r polygons, fig.cap="Map of the polygons for each ecoregion. Each polygon is colored with one of 9 colors based on the polygon names. Note that some neighboring polygons have the same color."}
...
```{r distance-coast, fig.cap="Map of the estimated distance from the nearest coastal edge."}
include_graphics('../figures/input-data/dist-m.png')
```
