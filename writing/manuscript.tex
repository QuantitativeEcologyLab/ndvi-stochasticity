...
\begin{figure}[h]
    ...
    \caption{Estimated mean NDVI (A) and DENVar (B) for 2003-07-02. \textcolor{red}{CHANGE TO LONG-TERM MEAN?}}
    \label{estimates}
\end{figure}
...
Other variables to potentially add to hexplots:
...
\item extreme weather event
\item invasive species
\item disease occurrence?
\end{itemize}
