...
We represent NDVI using a modified version of Fabio Crameri's divergent *bukavu* palette [@crameri_ref], which has high-contrast for deuteranope and protanope vision. For NDVI values between 0 and 1 (the right half of the palette), the colors have sufficient contrast for both tritanope and achomatic vision. Appendix A contains an approximate representation of the color palette for each vision type.

## Input data

Maps are in Aappendix A.
